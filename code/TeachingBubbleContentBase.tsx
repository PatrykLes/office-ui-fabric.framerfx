...
const InnerTeachingBubbleContentBase: React.SFC = props => {
  return <System.TeachingBubbleContentBase {...props} style={style} />;
};

export const TeachingBubbleContentBase = withHOC(
  InnerTeachingBubbleContentBase
);
...
addPropertyControls(TeachingBubbleContentBase, {
