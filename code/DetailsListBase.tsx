...
const InnerDetailsListBase: React.SFC = props => {
  return <System.DetailsListBase {...props} style={style} />;
};

export const DetailsListBase = withHOC(InnerDetailsListBase);
...
addPropertyControls(DetailsListBase, {
