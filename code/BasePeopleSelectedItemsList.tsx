...
const InnerBasePeopleSelectedItemsList: React.SFC = props => {
  return <System.BasePeopleSelectedItemsList {...props} style={style} />;
};

export const BasePeopleSelectedItemsList = withHOC(
  InnerBasePeopleSelectedItemsList
);
...
addPropertyControls(BasePeopleSelectedItemsList, {
  ...
  isValid: { title: "IsValid", defaultValue: false, type: ControlType.Boolean },
  blockRecipientRemoval: {
    title: "BlockRecipientRemoval",
    defaultValue: false,
    type: ControlType.Boolean
  },
  shouldBlockSelection: {
    title: "ShouldBlockSelection",
    defaultValue: false,
    type: ControlType.Boolean
  },
  canExpand: {
