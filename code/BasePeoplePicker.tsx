...
const InnerBasePeoplePicker: React.SFC = props => {
  return <System.BasePeoplePicker {...props} style={style} />;
};

export const BasePeoplePicker = withHOC(InnerBasePeoplePicker);

BasePeoplePicker.defaultProps = {
  width: 150,
  height: 50
};

addPropertyControls(BasePeoplePicker, {
