...
const InnerMemberListPeoplePicker: React.SFC = props => {
  return <System.MemberListPeoplePicker {...props} style={style} />;
};

export const MemberListPeoplePicker = withHOC(InnerMemberListPeoplePicker);

MemberListPeoplePicker.defaultProps = {
  width: 150,
  height: 50
};

addPropertyControls(MemberListPeoplePicker, {
