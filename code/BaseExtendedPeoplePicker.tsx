...
const InnerBaseExtendedPeoplePicker: React.SFC = props => {
  return <System.BaseExtendedPeoplePicker {...props} style={style} />;
};

export const BaseExtendedPeoplePicker = withHOC(InnerBaseExtendedPeoplePicker);

BaseExtendedPeoplePicker.defaultProps = {
  width: 150,
  height: 50
};

addPropertyControls(BaseExtendedPeoplePicker, {
