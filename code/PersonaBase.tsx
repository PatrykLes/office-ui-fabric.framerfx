...
const InnerPersonaBase: React.SFC = props => {
  return <System.PersonaBase {...props} style={style} />;
};

export const PersonaBase = withHOC(InnerPersonaBase);
...
addPropertyControls(PersonaBase, {
