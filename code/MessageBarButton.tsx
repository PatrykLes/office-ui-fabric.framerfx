...
const InnerMessageBarButton: React.SFC = props => {
  return <System.MessageBarButton {...props} style={style} />;
};

export const MessageBarButton = withHOC(InnerMessageBarButton);

MessageBarButton.defaultProps = {
  width: 150,
  height: 50
};

addPropertyControls(MessageBarButton, {
