...
const InnerBaseButton: React.SFC = props => {
  return <System.BaseButton {...props} style={style} />;
};

export const BaseButton = withHOC(InnerBaseButton);
...
addPropertyControls(BaseButton, {
  baseClassName: {
    title: "BaseClassName",
    defaultValue: "",
