...
const InnerTextFieldBase: React.SFC = props => {
  return <System.TextFieldBase {...props} style={style} />;
};

export const TextFieldBase = withHOC(InnerTextFieldBase);
...
addPropertyControls(TextFieldBase, {
  multiline: {
    title: "Multiline",
    defaultValue: false,
